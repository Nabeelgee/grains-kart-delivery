...
export function PartnerCTA() {
  return <section className="py-16 md:py-24 bg-foreground text-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          }].map((item, index) => <div key={item.title} className="flex items-start gap-4 p-4 rounded-xl bg-background/5 backdrop-blur">
